{
  programs.plasma = {
    shortcuts = {
      ...
      "ActivityManager"."switch-to-activity-7948fe78-f2c7-487f-b4e5-cd88f6e0834e" = [];
      "ActivityManager"."switch-to-activity-a9c5a752-3241-43e6-81e3-61a04968b71d" = [];
      "ActivityManager"."switch-to-activity-acf1364c-b38b-4534-b767-2a377147e52a" = [];
      "ActivityManager"."switch-to-activity-bd24ba9f-54c6-4a7d-8bfe-738e9af88f81" = [];
      "ActivityManager"."switch-to-activity-f25567e6-3d72-4b7b-8342-a40638bae27b" = [];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."2acf1aa8-fd55-45d8-a115-565ff9b525c4" = "BuS";
      "kactivitymanagerdrc"."activities"."72dc4e8c-8ee3-476a-a644-6559f67273d6" = "Rust";
      "kactivitymanagerdrc"."activities"."7948fe78-f2c7-487f-b4e5-cd88f6e0834e" = "DSAL";
      "kactivitymanagerdrc"."activities"."a9c5a752-3241-43e6-81e3-61a04968b71d" = "Default";
      "kactivitymanagerdrc"."activities"."acf1364c-b38b-4534-b767-2a377147e52a" = "0 Default";
      "kactivitymanagerdrc"."activities"."bd24ba9f-54c6-4a7d-8bfe-738e9af88f81" = "FoSAP";
      "kactivitymanagerdrc"."activities"."f25567e6-3d72-4b7b-8342-a40638bae27b" = "LAFI";
      "kactivitymanagerdrc"."activities-icons"."2acf1aa8-fd55-45d8-a115-565ff9b525c4" = "preferences-system-linux";
      "kactivitymanagerdrc"."activities-icons"."72dc4e8c-8ee3-476a-a644-6559f67273d6" = "text-rust";
      "kactivitymanagerdrc"."activities-icons"."7948fe78-f2c7-487f-b4e5-cd88f6e0834e" = "distribute-graph";
      "kactivitymanagerdrc"."activities-icons"."acf1364c-b38b-4534-b767-2a377147e52a" = "activities";
      "kactivitymanagerdrc"."activities-icons"."bd24ba9f-54c6-4a7d-8bfe-738e9af88f81" = "snap-nodes-smooth-symbolic";
      "kactivitymanagerdrc"."activities-icons"."f25567e6-3d72-4b7b-8342-a40638bae27b" = "math7";
      "kactivitymanagerdrc"."main"."currentActivity" = "acf1364c-b38b-4534-b767-2a377147e52a";
      "kactivitymanagerdrc"."main"."runningActivities" = "f25567e6-3d72-4b7b-8342-a40638bae27b,72dc4e8c-8ee3-476a-a644-6559f67273d6,2acf1aa8-fd55-45d8-a115-565ff9b525c4,bd24ba9f-54c6-4a7d-8bfe-738e9af88f81,7948fe78-f2c7-487f-b4e5-cd88f6e0834e";
      "kactivitymanagerdrc"."main"."stoppedActivities" = "";
      "kcminputrc"."Libinput/1267/12553/ELAN2204:00 04F3:3109 Touchpad"."NaturalScroll" = true;
      "kcminputrc"."Libinput/1267/12553/ELAN2204:00 04F3:3109 Touchpad"."PointerAcceleration" = 0.2;
      "kcminputrc"."Libinput/1267/12553/ELAN2204:00 04F3:3109 Touchpad"."TapToClick" = true;
      ...
      "kdeglobals"."WM"."activeBackground" = "71,80,87";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{061af7ff-82f4-4ceb-b0fe-38839eae25c8}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{0198a093-f38e-4882-9ba9-c3302ba1363b}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{379f8eca-9be1-48e9-98d1-7198cdc55318}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{7a1912bc-b1ac-435a-9aa9-4240a9fb054b}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{71c941ec-0f15-4678-a89f-5499a7846775}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{68f8cb28-46b4-4596-9f1f-14c4c665b8cc}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{28e824ad-c5dd-41f7-89d9-a53aeb3d8f2e}";
      ...
      "ksmserverrc"."SubSession: 54d73353-d9c8-4b11-af46-4307f11710bb"."count" = 0;
      "ksmserverrc"."SubSession: 92e29be4-128a-4e0f-9fc1-856dc996e56e"."count" = 0;
      "kwalletrc"."Wallet"."First Use" = false;
      "kwinrc"."Desktops"."Id_1" = "fa0f93b6-f0be-4c49-bc2e-5a3d6a2c26ce";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Effect-overview"."BorderActivate" = 9;
      "kwinrc"."NightColor"."Active" = true;
      "kwinrc"."NightColor"."DayTemperature" = 4000;
      "kwinrc"."NightColor"."LatitudeAuto" = 50.39;
      "kwinrc"."NightColor"."LongitudeAuto" = 7.57;
      "kwinrc"."NightColor"."NightTemperature" = 3100;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/03a7fc6a-83ab-5131-99f2-5f1e78b70205"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/9d0a4a6c-74fb-5abf-89ed-b7e0bcaa5bcb"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/e3898a0b-52f3-5aa2-b702-3c29326aadfd"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Xwayland"."Scale" = 1.25;
      "kwinrulesrc"."1"."Description" = "Application settings for org.kde.konsole";
      "kwinrulesrc"."1"."activity" = "acf1364c-b38b-4534-b767-2a377147e52a";
      "kwinrulesrc"."1"."activityrule" = 3;
      "kwinrulesrc"."1"."wmclass" = "konsole org.kde.konsole";
      "kwinrulesrc"."1"."wmclasscomplete" = true;
      "kwinrulesrc"."1"."wmclassmatch" = 1;
      "kwinrulesrc"."2"."Description" = "Share Firefox across Activities";
      "kwinrulesrc"."2"."activity" = "00000000-0000-0000-0000-000000000000";
      "kwinrulesrc"."2"."activityrule" = 3;
      "kwinrulesrc"."2"."wmclass" = "firefox";
      "kwinrulesrc"."2"."wmclassmatch" = 1;
      "kwinrulesrc"."3"."Description" = "Share Obsidian across Activities";
      ...
      "kwinrulesrc"."35440504-2fbd-43fd-b56d-991018cc4cb1"."Description" = "Share Obsidian across Activities";
      "kwinrulesrc"."35440504-2fbd-43fd-b56d-991018cc4cb1"."activity" = "00000000-0000-0000-0000-000000000000";
      "kwinrulesrc"."35440504-2fbd-43fd-b56d-991018cc4cb1"."activityrule" = 3;
      "kwinrulesrc"."35440504-2fbd-43fd-b56d-991018cc4cb1"."wmclass" = "obsidian";
      "kwinrulesrc"."35440504-2fbd-43fd-b56d-991018cc4cb1"."wmclassmatch" = 1;
      "kwinrulesrc"."8459067b-1c60-4b87-99a9-cf9e0f147ed9"."Description" = "Application settings for org.kde.konsole";
      "kwinrulesrc"."8459067b-1c60-4b87-99a9-cf9e0f147ed9"."activity" = "acf1364c-b38b-4534-b767-2a377147e52a";
      "kwinrulesrc"."8459067b-1c60-4b87-99a9-cf9e0f147ed9"."activityrule" = 3;
      "kwinrulesrc"."8459067b-1c60-4b87-99a9-cf9e0f147ed9"."wmclass" = "konsole org.kde.konsole";
      "kwinrulesrc"."8459067b-1c60-4b87-99a9-cf9e0f147ed9"."wmclasscomplete" = true;
      "kwinrulesrc"."8459067b-1c60-4b87-99a9-cf9e0f147ed9"."wmclassmatch" = 1;
      "kwinrulesrc"."General"."count" = 3;
      "kwinrulesrc"."General"."rules" = "1,2,3";
      "kwinrulesrc"."c4623f96-e8d6-423b-8799-25adb5ccee7e"."Description" = "Application settings for firefox";
      "kwinrulesrc"."c4623f96-e8d6-423b-8799-25adb5ccee7e"."activity" = "00000000-0000-0000-0000-000000000000";
      "kwinrulesrc"."c4623f96-e8d6-423b-8799-25adb5ccee7e"."activityrule" = 3;
      "kwinrulesrc"."c4623f96-e8d6-423b-8799-25adb5ccee7e"."wmclass" = "firefox";
      "kwinrulesrc"."c4623f96-e8d6-423b-8799-25adb5ccee7e"."wmclassmatch" = 1;
      ...
      "plasma-localerc"."Formats"."LC_MEASUREMENT" = "en_IE.UTF-8";
      "plasma-localerc"."Formats"."LC_MONETARY" = "en_IE.UTF-8";
      "plasma-localerc"."Formats"."LC_NAME" = "en_IE.UTF-8";
      "plasma-localerc"."Formats"."LC_NUMERIC" = "en_IE.UTF-8";
      "plasma-localerc"."Formats"."LC_PAPER" = "en_IE.UTF-8";
      "plasma-localerc"."Formats"."LC_TELEPHONE" = "de_DE.UTF-8";
      "plasma-localerc"."Formats"."LC_TIME" = "en_IE.UTF-8";
    };
  };
}
